...
hittable_list random_scene() {
    ...
    auto sphere_material_b = make_shared<metal>(color(0.5, 0.5, 0.8),0.0);
    ...
    // double grid_size = 12.0;
    // double sphere_size = 0.5;
    // for (int i = 0;i < grid_size; ++i) {
    //     for (int j = 0; j < grid_size; ++j) {
    //         for (int k = 0; k < grid_size; ++k) {
    //             world.add(make_shared<sphere>(point3(i-grid_size*sphere_size,j-grid_size*sphere_size, k-grid_size*sphere_size), sphere_size, 
    //                 make_shared<metal>(color(i/grid_size, j/grid_size, k/grid_size),0.7)));

    //         }
    //     }
    // }

    // Row 2 - Lambertian and glass?
    return world;
}
